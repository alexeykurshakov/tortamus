...
public class GameConfig
{
    ...
    const string kPlayerPrefsName = "options2";    

	private static int _currentProfile;

    public float Масса_Диска = 2.6f;
    public float Масса_Шара = 0.9f;

    public float Коэф_Трения = 0.1f;
	public float Усил_Коэф_Трения = 0.1f;
	public float Коэф_Трения_Покоя = 1.4f;
    public float Коэф_Трения_Качения = 0.3f;
    public float Макс_Угл_Скорость = 15f;        
    public float Уск_Своб_Падения = -2f;

    public float Время_Нагрева = 4f;	       
